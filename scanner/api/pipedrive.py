...
class PostPipedriveActivity:
    """Simple post request to Pipedrive API."""

    def __init__(self, due_date, due_time, subject, public_description, activity_type="Task", busy_flag=False, done=0):
        """Init connector."""
        self.body = self.generate_body(due_date, due_time, subject, public_description, activity_type, busy_flag, done)
